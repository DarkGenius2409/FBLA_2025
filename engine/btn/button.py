import pygame.mouse
from engine.colors import BTN_COLOR, BTN_SELECTED_COLOR, BTN_DESTRUCTIVE_COLOR, BTN_DESTRUCTIVE_BORDER_COLOR, BTN_DESTRUCTIVE_SELECTED_COLOR, BTN_TEXT_COLOR, BTN_BORDER_COLOR
